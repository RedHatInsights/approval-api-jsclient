...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServiceApprovalApIs.Template();
  });
  ...
  describe('Template', function() {
    it('should create an instance of Template', function() {
      ...
      //var instane = new InsightsServiceApprovalApIs.Template();
      //expect(instance).to.be.a(InsightsServiceApprovalApIs.Template);
    });
