...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServiceApprovalApIs.TemplateOut();
  });
  ...
  describe('TemplateOut', function() {
    it('should create an instance of TemplateOut', function() {
      // uncomment below and update the code to test TemplateOut
