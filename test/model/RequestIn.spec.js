...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServiceApprovalApIs.RequestIn();
  });
  ...
  describe('RequestIn', function() {
    it('should create an instance of RequestIn', function() {
      // uncomment below and update the code to test RequestIn
      //var instane = new InsightsServiceApprovalApIs.RequestIn();
      //expect(instance).to.be.a(InsightsServiceApprovalApIs.RequestIn);
    });
