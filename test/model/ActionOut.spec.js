...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new InsightsServiceApprovalApIs.ActionOut();
  });
  ...
  describe('ActionOut', function() {
    it('should create an instance of ActionOut', function() {
      ...
      //var instane = new InsightsServiceApprovalApIs.ActionOut();
      //expect(instance).to.be.a(InsightsServiceApprovalApIs.ActionOut);
    });
